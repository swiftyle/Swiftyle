                    ...
                    <form class="theme-form login-form" action="{{ route('register') }}" method="POST" style="border-radius:20px">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="name" type="text" name="name" required placeholder="Your Name" autocomplete="name"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="email" type="email" name="email" required placeholder="Test@gmail.com" autocomplete="email"/>
                            </div>
                        </div>
                        <div class="form-group">
