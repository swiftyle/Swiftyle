                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/seller') }} {{ routeActive('data-shop') }}"
                            href="{{ route('seller.index') }}"><i data-feather="user-plus"></i><span>Data
                                Shop</span></a>
                    </li>

                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/orders') }} {{ routeActive('data-order') }}"
                            href="{{ route('orders.index') }}"><i data-feather="shopping-cart"></i><span>Data
                                Order</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/specification') }} {{ routeActive('data-product') }}"
                            href="{{ route('products.index') }}"><i data-feather="grid"></i><span>Data
                                Product</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/specification') }} {{ routeActive('data-preference') }}"
                            href="{{ route('preferences.index') }}"><i data-feather="grid"></i><span>Data
                                Preference</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/specification') }} {{ routeActive('data-style') }}"
                            href="{{ route('styles.index') }}"><i data-feather="grid"></i><span>Data Style</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/transaction') }} {{ routeActive('data-order') }}"
                            href="{{ route('orders.index') }}"><i data-feather="database"></i><span>Data
                                Order</span></a>
                    </li>

                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/transaction') }} {{ routeActive('histrory-order') }}"
                            href="{{ route('order.histories.index') }}"><i data-feather="database"></i><span>History
                                Order</span></a>
                    </li>

                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/transaction') }} {{ routeActive('complaint-user') }}"
                            href="{{ route('complaints.index') }}"><i
                                data-feather="exclamation-triangle"></i><span>Complaint User</span></a>
                    </li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{ prefixActive('/developer-team') }}{{ routeActive('developer') }}"
                            href="{{ route('developers.index') }}"><i
                                data-feather="grid"></i><span>Developer</span></a>
                    </li>

                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('support') }}"
                            href="{{ route('supports') }}"><i data-feather="grid"></i><span>Support</span></a>
                    </li>
